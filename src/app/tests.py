...
class TestMain(unittest.TestCase):
    ...
    @patch("main.inputs")
    def test_no_deploy_on_friday(
        self, mock_inputs, mock_print, mock_sys_exit, mock_get_today_and_day_name
    ):
    ...
    @patch("builtins.print")
    @patch("main.inputs")
    def test_deploy_on_monday(
        self, mock_inputs, mock_print, mock_sys_exit, mock_get_today_and_day_name
    ):
        """Test deploy on Monday."""
        # assign
        mock_inputs.NO_DEPLOYMENT_DAYS = "Friday, Saturday, Sunday"
        mock_inputs.TZ = "MST"
        mock_inputs.COUNTRY = "US"
    ...
    def test_deploy_on_holiday(
        ...
        mock_inputs.COUNTRY = "US"
        mock_inputs.HOLIDAYS = "false"
        mock_get_today_and_day_name.return_value = (
